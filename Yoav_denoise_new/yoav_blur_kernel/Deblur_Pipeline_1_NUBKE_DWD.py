...
sys.path.append(f"{PARAMETER.CHECKPOINTS}/NonUniformBlurKernelEstimation/NonUniformBlurKernelEstimation/utils_NUBKE") #ToDo
sys.path.append(f"{PARAMETER.CHECKPOINTS}/NonUniformBlurKernelEstimation/NonUniformBlurKernelEstimation/utils_NUBKE")
sys.path.append(f"{PARAMETER.CHECKPOINTS}/NonUniformBlurKernelEstimation/NonUniformBlurKernelEstimation")
sys.path.append(f"{PARAMETER.CHECKPOINTS}/dwdn/dwdn")
...
from checkpoints.NonUniformBlurKernelEstimation.NonUniformBlurKernelEstimation.models.TwoHeadsNetwork import TwoHeadsNetwork

###Load the bas imports, they couse to some issues whne trying to use cv2
from checkpoints.NonUniformBlurKernelEstimation.NonUniformBlurKernelEstimation.utils_NUBKE.visualization import \
    save_kernels_grid, get_kernels_grid

from checkpoints.NonUniformBlurKernelEstimation.NonUniformBlurKernelEstimation.utils_NUBKE.restoration import \
...
if __name__ == "__main__":
    with torch.no_grad():
        image_path = "/home/nehoray/PycharmProjects/VideoImageEnhancement/data/data_croped_for_deblur_or_kernel_blur/00057780.png"
