...
current_level_reference_tensor_zero_mean = (torch.randn((1 ,N)).cuda()).repeat(T,1) # this should be (1 ,N)
...
def images_and_gradients_to_delta_p_yuri(H_matrix,
    ...
    ### Yuri calculations: ###
    current_level_reference_tensor_zero_mean = current_level_reference_tensor_zero_mean.unsqueeze(1).unsqueeze \
        (1)  # ->[T,1,1,N]
...
images_and_gradients_to_delta_p_yuri(H_matrix,
                                         current_level_reference_tensor_zero_mean,
                                         current_level_input_tensor_warped,
                                         Jx_chosen_values, Jy_chosen_values,
                                         gx_chosen_values, gy_chosen_values)
