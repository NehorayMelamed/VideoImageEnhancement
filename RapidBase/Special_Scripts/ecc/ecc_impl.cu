...
//   std::cout << std::endl;
  ...
  thrust::reduce_by_key(thrust::device,keys_iter, keys_iter + total_input_num, input_iter, thrust::make_discard_iterator(), output_iter, binary_pred, add_output_tup<TP>());
};
