...
#pragma unroll
  ...
  auto CCL_labels = cv::cuda::GpuMat(input_sizes[1],input_sizes[2], CV_32S ,input_tensor_raw_ptr);
  ...
  //cout << z << endl;
  thrust::copy( CCL_tensor_raw_ptr, CCL_tensor_raw_ptr+input_sizes[1]*input_sizes[2], std::ostream_iterator<float>(std::cout, " "));
