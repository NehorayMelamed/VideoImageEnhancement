...
# torch.cuda.synchronize()
# start_time = time.time()
# c = ecc_bilinear_interpolation.ecc_bilinear_interpolation_no_grad(input_im25age, H_matrix, X_mat_chosen_values, Y_mat_chosen_values)
# torch.cuda.synchronize()
# end_time = time.time()
...
#     # to test the correctness of the calculations we will make the bilinear25
