...
from Dudy import Align_FeatureBased_SIFT, Align_ECC, affine_parameters_from_homography_matrix
from _internal_utils.test_exceptions import raise_if
from _transforms.affine_transformations import affine_transform_interpolated
from alignments_layers import minSAD_transforms_layer, LinearPolarLayer, Gimbaless_Rotation_Layer_Torch
...
from _internal_utils.torch_utils import MatrixOrigami, unravel_index, NoMemoryMatrixOrigami, \
    construct_tensor, unravel_index_torch
from _transforms.rotate_matrix import structure_thetas, fftshifted_formatted_vectors
from alignments import circular_cc_shifts, normalized_cc_shifts, min_SAD_detect_shifts
from transforms import shift_matrix_subpixel, rotate_matrix
...
def get_default_noise_dict():
    ...
    # Paths:
    # (1). Externals_Libraries Readout Noise Path:
    IO_dict.readout_noise_external_image_path = ''
    IO_dict.readout_noise_search_pattern = '*'
    # (2). Externals_Libraries Non-Uniformity Pattern Path:
    ...
    # Externals_Libraries readout noise parameters
    ...
    # Externals_Libraries image non uniformity parameters
