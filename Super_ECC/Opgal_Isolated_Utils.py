...
class Super_CC_Layer(nn.Module):
    ...
    def forward(self, input_tensor):
        ...
        subpixel_W, subpixel_H = self.find_gaussian_peak_layer.forward(cc_CC.squeeze(1))
        ...
        return subpixel_H, subpixel_W, input_tensor_stretched_original_warped_mean, input_tensor_stretched_original_warped
