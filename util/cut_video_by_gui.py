...
if __name__ == '__main__':
    editor = VideoEditor('/home/nehoray/PycharmProjects/car_statistics/data/15_videos/2.mp4', '2.mp4')
...
#
# # # Usage example
# # editor = VideoEditor('/home/nehoray/PycharmProjects/Shaback/data/videos/toem.mp4', 'tweets_per_accounts.mp4')
# # start, end = editor.process_video()
# # print(f"Start frame: {start}, End frame: {end}")