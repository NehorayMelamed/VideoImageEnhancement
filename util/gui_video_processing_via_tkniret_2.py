...
class AppDemo:
    def __init__(self, root):
        ...
        self.output_dir = "tweets_per_accounts"  # Output directory name
    ...
    def browse_video(self):
        ...
        # Define the tweets_per_accounts directory and path
        output_directory = self.output_dir  # Use the selected tweets_per_accounts directory
