...
from VideoImageEnhancement.Detection.GroundingDINO.groundingdino.util.utils import clean_state_dict
from VideoImageEnhancement.Detection.GroundingDINO.groundingdino.util.inference import annotate, load_image, predict
