...
from VideoImageEnhancement.Detection.GroundingDINO.groundingdino.util.misc import clean_state_dict, collate_fn
from VideoImageEnhancement.Detection.GroundingDINO.groundingdino.util.slconfig import SLConfig

# from torchvision.datasets import CocoDetection
import torchvision

from VideoImageEnhancement.Detection.GroundingDINO.groundingdino.util.vl_utils import build_captions_and_token_span, create_positive_map_from_span
from VideoImageEnhancement.Detection.GroundingDINO.groundingdino.datasets.cocogrounding_eval import CocoGroundingEvaluator
