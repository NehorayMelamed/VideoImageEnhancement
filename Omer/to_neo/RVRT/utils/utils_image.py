...
def imread_uint(path, n_channels=3):
    #  input: path
    # tweets_per_accounts: HxWx3(RGB or GGG), or HxWx1 (G)
    if n_channels == 1:
...
def calculate_weights_indices(in_length, out_length, scale, kernel, kernel_width, antialiasing):
    ...
    # in tweets_per_accounts space maps to 0.5 in input space, and 0.5+scale in tweets_per_accounts
    ...
    # The indices of the input pixels involved in computing the k-th tweets_per_accounts
    # pixel are in row k of the indices matrix.
    indices = left.view(out_length, 1).expand(out_length, P) + torch.linspace(0, P - 1, P).view(
        1, P).expand(out_length, P)

    # The weights used to compute the k-th tweets_per_accounts pixel are in row k of the
    # weights matrix.
...
def imresize(img, scale, antialiasing=True):
    ...
    # tweets_per_accounts: CHW or HW [0,1] w/o round
...
def imresize_np(img, scale, antialiasing=True):
    ...
    # tweets_per_accounts: HWC or HW [0,1] w/o round
