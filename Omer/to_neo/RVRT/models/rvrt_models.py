...
from Omer.to_neo.RVRT.models.network_rvrt import RVRT as RVRT_omer
...
def RVRT_SR_30_frames(pretrained='REDS', checkpoint_path='',
    ...
    sr_model = RVRT_omer(upscale=4, clip_size=2, img_size=[2, 64, 64], window_size=[2, 8, 8], num_blocks=[1, 2, 1],
...
def RVRT_denoise_16_frames(pretrained='DAVIS', checkpoint_path='',
    ...
    denoise_model = RVRT_omer(upscale=1, clip_size=2, img_size=[2, 64, 64], window_size=[2, 8, 8], num_blocks=[1, 2, 1],
...
def RVRT_deblur_16_frames(pretrained='DVD', checkpoint_path='',
    ...
    deblur_model = RVRT_omer(upscale=1, clip_size=2, img_size=[2, 64, 64], window_size=[2, 8, 8], num_blocks=[1, 2, 1],
                    depths=[2, 2, 2], embed_dims=[192, 192, 192], num_heads=[6, 6, 6],
