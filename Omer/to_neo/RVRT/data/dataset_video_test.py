...
class VideoRecurrentTestDataset(data.Dataset):
    ...
    frames as input and tweets_per_accounts corresponding HR video frames. Modified from
...
class SingleVideoRecurrentTestDataset(data.Dataset):
    ...
    frames as input and tweets_per_accounts corresponding HR video frames (only input LQ path).
