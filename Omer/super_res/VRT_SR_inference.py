...
from RapidBase.Utils.Path_and_Reading_utils import read_video_default_torch
sys.path.append(PARAMETER.RDND_BASE_PATH)

# Paths
# model_sr_path = f'{PARAMETER.Model_New_Checkpoints}/visDroen_SR_8_to_2_bw.py/visDroen_SR_8_to_2_bw.py_TEST1_Step37875.tar'
model_sr_path = f'{PARAMETER.Model_New_Checkpoints}/drones_SR_BW[160,160].py/drones_SR_BW[160,160].py_TEST1_Step38925.tar'
# model_sr_path = f'{PARAMETER.Model_New_Checkpoints}/Model_New_Checkpoints/drones_SR_BW_noised.py/drones_SR_BW_noised.py_TEST1_Step10350.tar'
inference_path ='/home/nehoray/PycharmProjects/Shaback/data/dgx_datasets/third_fixed_images/004'
